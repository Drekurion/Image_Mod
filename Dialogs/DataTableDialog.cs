...
namespace APO_Projekt
{
	public partial class DataTableDialog : Form
	{
		public DataTableDialog(VectorOfMat cnt, DataTableDialogType dialogType)
		{
			...
			switch(dialogType)
			{
				case DataTableDialogType.Moments:
					{
						this.Text = "Moments";
				...
				case DataTableDialogType.Diameter:
					{
						this.Text = "Area and circumference";
						display.Columns.Add("Area", "Area");
						display.Columns.Add("Circumference", "Circumference");
						for (int i = 0; i < size; ++i)
						{
				...
				case DataTableDialogType.ShapeAspects:
					{
						this.Text = "Shape aspects";
